      ...
      <section className="py-24 bg-[#F2EDE4]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            {/* Contact Info */}
            <motion.div {...fadeUp}>
              <h2 className="text-3xl font-black text-cafe mb-8">{t('infoTitle')}</h2>
              ...
              {sent ? (
                <div className="h-full flex items-center justify-center">
                  <div className="text-center bg-white rounded-3xl p-12 shadow-md">
                    ...
                    <h3 className="text-2xl font-black text-cafe mb-2">{t('sent.title')}</h3>
                ...
                <div className="bg-white rounded-3xl p-8 shadow-md">
                  <h2 className="text-2xl font-black text-cafe mb-6">{t('form.title')}</h2>
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      <label className="block text-sm font-semibold text-cafe mb-1.5">{t('form.subject')}</label>
                      <select
                        name="asunto"
                        value={form.asunto}
                        onChange={handleChange}
                      ...
                      >
                        ...
                        <option>{t('form.subjectOptions.jovenesCaficultores')}</option>
                        <option>{t('form.subjectOptions.bosquesDelManana')}</option>
                        <option>{t('form.subjectOptions.rsGold')}</option>
                        <option>{t('form.subjectOptions.derechosHumanos')}</option>
                        <option>{t('form.subjectOptions.incentivoCondicional')}</option>
                        <option>{t('form.subjectOptions.nespresso')}</option>
                        <option>{t('form.subjectOptions.alianza')}</option>
                        <option>{t('form.subjectOptions.otro')}</option>
                      </select>
                    </div>

                    <div>
                      <label className="block text-sm font-semibold text-cafe mb-1.5">{t('form.message')}</label>
                      <textarea
                        name="mensaje"
                        value={form.mensaje}
                        onChange={handleChange}
